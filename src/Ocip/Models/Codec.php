...
class Codec extends \MyCLabs\Enum\Enum
{
    ...
    const G711ALAW = 'G711alaw';

    const G711ULAW = 'G711ulaw';

    const G722 = 'G722';

    const G723_53 = 'G723-53';

    const G723_63 = 'G723-63';

    const G723A_53 = 'G723A-53';

    const G723A_63 = 'G723A-63';

    const G726_16 = 'G726-16';

    const G726_24 = 'G726-24';

    const G726_32 = 'G726-32';

    const G726_40 = 'G726-40';

    const G728 = 'G728';

    const G729_8 = 'G729-8';

    const G729B_8 = 'G729B-8';
