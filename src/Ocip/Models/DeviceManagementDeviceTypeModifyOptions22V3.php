 ...
 *
 * @Groups [{"id":"6337d0cfba4de1c83587203c5b0bae54:2300","type":"sequence"}]
 */
class DeviceManagementDeviceTypeModifyOptions22V3
{
    /**
     ...
     *
     * @param string|null $autoLinkingDeviceType
     * @return $this
     */
    public function setAutoLinkingDeviceType($autoLinkingDeviceType = null)
    {
        if ($autoLinkingDeviceType === null) {
            $this->autoLinkingDeviceType = new \CWM\BroadWorksConnector\Ocip\Nil;
        } else {
