 ...
 *         The response is either an EnterpriseEnhancedCallLogsGetListResponse17sp4
 * or an ErrorResponse.
 *         The following elements are only used in AS data mode:
 *           callAuthorizationCodeFilter
 */
class EnterpriseEnhancedCallLogsGetListRequest17sp4 extends \CWM\BroadWorksConnector\Ocip\Models\C\OCIRequest
{
