 ...
 *         The response is either an EnterpriseEnhancedCallLogsGetListResponse20 or
 * an ErrorResponse.
 *         The following elements are only used in AS data mode:
 *           callAuthorizationCodeFilter
 *           callSecurityClassification
 */
class EnterpriseEnhancedCallLogsGetListRequest20 extends \CWM\BroadWorksConnector\Ocip\Models\C\OCIRequest
{
