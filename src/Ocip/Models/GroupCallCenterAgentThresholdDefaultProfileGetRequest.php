 ...
 *         If includeAgentsTable is set to true, a table with the list of agents
 * assigned to
 *         the profile is included in the response. The search criteria is used to
 * filter the 
 *         list of agents to be included in the table.
 *         The response is either a
 * GroupCallCenterAgentThresholdDefaultProfileGetResponse or an ErrorResponse.
 *
 * @see GroupCallCenterAgentThresholdDefaultProfileGetResponse
 * @see ErrorResponse
 */
class GroupCallCenterAgentThresholdDefaultProfileGetRequest extends \CWM\BroadWorksConnector\Ocip\Models\C\OCIRequest
{
    ...
    /**
     * Getter for includeAgentsTable
     *
     * @return bool
     */
    public function getIncludeAgentsTable()
    {
        return $this->includeAgentsTable instanceof \CWM\BroadWorksConnector\Ocip\Nil ? null : $this->includeAgentsTable;
    }

    /**
     * Setter for includeAgentsTable
     *
     * @param bool $includeAgentsTable
     * @return $this
     */
    public function setIncludeAgentsTable($includeAgentsTable)
    {
        $this->includeAgentsTable = $includeAgentsTable;
        return $this;
    }
     ...
     * @return $this
     */
    public function unsetIncludeAgentsTable()
    {
        $this->includeAgentsTable = null;
        return $this;
    }
