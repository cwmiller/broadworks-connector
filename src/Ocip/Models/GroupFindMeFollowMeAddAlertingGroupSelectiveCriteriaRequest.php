 ...
 *         For the callToNumber, the extension and number elements are not used and
 * the only types accepted for each number are Primary and Alternates. If other
 * type is specified the command fails.
