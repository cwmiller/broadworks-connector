 ...
 *         The response is either GroupUserCallWaitingSettingsGetListResponse or
 * ErrorResponse.
 ...
 * returned.
 *
 * @see GroupUserCallWaitingSettingsGetListResponse
 * @see ErrorResponse
 */
class GroupUserCallWaitingSettingsGetListRequest extends \CWM\BroadWorksConnector\Ocip\Models\C\OCIRequest
{
     ...
     *
     * @ElementName sortByServiceStatus
     * @return \CWM\BroadWorksConnector\Ocip\Models\SortByServiceStatus|null
     */
    public function getSortByServiceStatus()
    {
        return $this->sortByServiceStatus;
    }
     ...
     *
     * @ElementName searchCriteriaServiceStatus
     * @return \CWM\BroadWorksConnector\Ocip\Models\SearchCriteriaServiceStatus|null
     */
    public function getSearchCriteriaServiceStatus()
    {
        return $this->searchCriteriaServiceStatus;
    }
