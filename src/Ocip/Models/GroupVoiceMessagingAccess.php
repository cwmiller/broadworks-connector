 ...
 *         "Restricted" indicates that the choice to either use unified messaging
 * option (whereby the user can configure a mail server on which messages are
 * stored)
 *         or to forward the voice message to a designated email address is not
 * available.
 *
