 ...
 * @Groups [{"id":"f1088f4c5ceb30d524d2ba0f8097c393:1816","type":"sequence"}]
 */
class ServiceProviderCallProcessingGetPolicyResponse22V3 extends \CWM\BroadWorksConnector\Ocip\Models\C\OCIDataResponse
{
     ...
     * @var bool|null
     */
    private $useServiceProviderDCLIDSetting = null;
     ...
     *
     * @param string $networkCallsGatewayRouteIdentity
     * @return $this
     */
    public function setNetworkCallsGatewayRouteIdentity($networkCallsGatewayRouteIdentity)
    {
     ...
     *
     * @param string $networkURLCallsGatewayRouteIdentity
     * @return $this
     */
    public function setNetworkURLCallsGatewayRouteIdentity($networkURLCallsGatewayRouteIdentity)
    {
     ...
     *
     * @param string $emergencyCallsGatewayRouteIdentity
     * @return $this
     */
    public function setEmergencyCallsGatewayRouteIdentity($emergencyCallsGatewayRouteIdentity)
    {
     ...
     *
     * @param string $repairCallsGatewayRouteIdentity
     * @return $this
     */
    public function setRepairCallsGatewayRouteIdentity($repairCallsGatewayRouteIdentity)
    {
     ...
     *
     * @param string $callTypingErrorsGatewayRouteIdentity
     * @return $this
     */
    public function setCallTypingErrorsGatewayRouteIdentity($callTypingErrorsGatewayRouteIdentity)
    {
