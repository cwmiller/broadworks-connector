...
/**
 * ServiceProviderPortalPasscodeRulesGetResponse22
 *
 ...
 * @Groups [{"id":"f1088f4c5ceb30d524d2ba0f8097c393:5405","type":"sequence"}]
 */
class ServiceProviderPortalPasscodeRulesGetResponse22 extends \CWM\BroadWorksConnector\Ocip\Models\C\OCIDataResponse
{
     ...
     * @var bool|null
     */
    protected $enableDefaultPasscode = null;
     ...
     * @var string|null
     */
    protected $defaultPasscode = null;
     ...
     *
     * @param string $defaultPasscode
     * @return $this
     */
    public function setDefaultPasscode($defaultPasscode)
    {
