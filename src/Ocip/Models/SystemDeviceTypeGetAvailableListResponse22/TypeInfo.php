...
namespace CWM\BroadWorksConnector\Ocip\Models\SystemDeviceTypeGetAvailableListResponse22;
...
class TypeInfo
{
     ...
     *
     * @ElementName deviceTypeLevel
     * @param string|null $deviceTypeLevel
     * @return $this
     */
    public function setDeviceTypeLevel($deviceTypeLevel)
    {
