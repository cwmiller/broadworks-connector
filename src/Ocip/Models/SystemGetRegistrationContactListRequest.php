 ...
 *       This request handles all levels of administration privileges.  The content
 * of the response will only contain items within the scope of the requester's
 * login id.  At the system level any of the choice parameters may be specified to
 * filter the registrations listed.  At the service provider level the
 * serviceProviderId must be specified for the service provider and group options. 
 * When using the userId or linePort options the specified value must be valid for
 * that service provider login.  At the group level the servicProviderId and the
 * groupId must be specified for the group option. When using the userId or
 * linePort options the specified value must be valid for that group login.  The
 * serviceProviderId option is not valid at the group level.  At the user level
 * when using the userId or linePort options the specified value must be valid for
 * that user login.  The serviceProviderId and groupId options are not valid at the
 * user level.
