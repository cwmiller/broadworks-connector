...
/**
 * SystemTreatmentMappingCallBlockingServiceGetListRequest22
 *
 * Requests a table of all the existing Call Blocking Service Mappings in the
 * system.
 *         The response is either a
 * SystemTreatmentMappingCallBlockingServicesGetListResponse22
 *         or an ErrorResponse.
 *
 * @see SystemTreatmentMappingCallBlockingServicesGetListResponse22
 * @see ErrorResponse
 */
