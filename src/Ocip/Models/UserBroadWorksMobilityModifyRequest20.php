 ...
 *         If the request modifies the mobilePhoneNumber and the new number does
 * not belong to the appropriate Mobile Subscriber Directory Numbers pool, the
 * request is rejected. For a service provider the number must belong to the group
 * Mobile Subscriber Directory Numbers pool. For an enterprise user, the number
